...
public class BookMapTests {
    ...
    @BeforeClass
    //  Load in text files to be later used in combinatorial testing
    ...
    @Test
    // Test that the filenames in the BookMap are equal to the original file 
    // names used to create the each respective BookMap
    ...
    @Test
    // Ensure that a BookMap created with an empty file has a word count of zero
    ...
    @Test
    // Ensure that an empty file does not generate a valid BookMap
    public void testEmptyFileValidity(){
    	BookMap map = new BookMap("empty_file.txt");
    ...
    @Test
    // Ensure that strange characters do not get added to the BookMap as if they were words
    ...
    @Test
    // An empty bookmap should be valid after words are added to it
    ...
    @Test
    // All bookmaps should have a distance of zero when compared to themselves
    ...
    @Test
    // Ensure the proper message is displayed for an invalid file
    ...
    @Test
    // Ensure the proper message is displayed for a valid file 
    ...
    @Test
    // Ensure that the example output provided by the professor matches the output we get 
    ...
    @Test
    // Test that a BookMap made with an invalid file is not valid
    ...
    @Test
    // Ensure that a BookMap made with a null file is not valid
    ...
    @Test
    // Ensure that the distance between an invalid bookmap and itself is Not A Number
    ...
    @Test
    // Ensure that the print function contains every word in the original file
    ...
    @Test
    // Run a full combinatorial test on the provided example files and see what we get
    // This test is for observation only and can help compare your answers to other 
    // students answers
    ...
    @Test
    // Test that the distance between an valid BookMap and null book is not a number
    ...
    @Test
    // Check that adding words to the map is the same as a file with only those words
    ...
    @Test
    // Ensure that words added to the table are valid
    ...
    @Test
    // ensure that the processing of the text operates "quickly"
